...
const Home = () => {
  return (
    <div className='h-[100vh] bg-gradient-to-b from-black to-gray-900 text-white text-center py-20 px-4 '>
       <div className="">
    ...
    <div className="flex justify-center gap-10 mt-12">
      <GradientButton text="Check Safety of Your Area" />
      <GradientButton text="Ask the AI Legal Assistant" />
    </div>
    </div>
    {/* <Map/> */}
    </div>
